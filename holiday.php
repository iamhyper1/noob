            ...
            <div class="menu-par">
                ...
                <div class="nav">
                    <ul>
                        ...
                        <li><a class="menu_hover" href="holiday.html">Holyday</a></li>
    ...
    <header>
        ...
        <div class="video">
            <video id="video" autoplay loop muted>
                <source type="video/mp4" src="images/Your MIND will Relax After Watching _ THIS (4K) NEPAL CINEMATIC SHORT FILM.mp4" />            </video>
        </div>
    </header>
                ...
                <div class="counter-form">
                    <form action="/action_page.php">
                        ...
                        <select id="country" name="country">
                            ...
                            <option value="nepal">Nepal</optiion>
                        </select>
